...
#create_clock -add -name sys_clk_pin -period 3.00 -waveform {0 3} [get_ports clk]
...
#set_property PACKAGE_PIN V15 [get_ports {x6}]
#set_property IOSTANDARD LVCMOS33 [get_ports {x6}]
#set_property PACKAGE_PIN W14 [get_ports {x7}]
#set_property IOSTANDARD LVCMOS33 [get_ports {x7}]
#set_property PACKAGE_PIN W13 [get_ports {x8}]
#set_property IOSTANDARD LVCMOS33 [get_ports {x8}]
#set_property PACKAGE_PIN V2 [get_ports {s1}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s1}]
#set_property PACKAGE_PIN T3 [get_ports {s2}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s2}]
#set_property PACKAGE_PIN T2 [get_ports {s3}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s3}]

#set_property PACKAGE_PIN R3 [get_ports {x2}]
#set_property IOSTANDARD LVCMOS33 [get_ports {x2}]
#set_property PACKAGE_PIN W2 [get_ports {clk}]
#set_property IOSTANDARD LVCMOS33 [get_ports {clk}]
set_property PACKAGE_PIN U1 [get_ports {sb}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {s1}]
#set_property PACKAGE_PIN U19 [get_ports {c1}]
...
set_property PACKAGE_PIN W3 [get_ports {lb0}]
set_property IOSTANDARD LVCMOS33 [get_ports {lb0}]
set_property PACKAGE_PIN U3 [get_ports {lb1}]
set_property IOSTANDARD LVCMOS33 [get_ports {lb1}]
set_property PACKAGE_PIN P3 [get_ports {lb2}]
